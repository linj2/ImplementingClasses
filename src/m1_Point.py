...
# ----------------------------------------------------------------------
# TODONE: 2. With your instructor, READ THE INSTRUCTIONS
...
class Point(object):
    """Represents a 20 point in a coordinate frame."""
    ...
    def move_to(self, x, y):
        ...
        self.y = y
        self.moves += 1
        self.distance += math.sqrt((self.x-self.before_move_x)**2+(self.y-self.before_move_y)**2)
    ...
    def get_distance_from(self, other_pt):
        x = other_pt.x -self.x
        y = other_pt.y - self.y
...
def test_repr():
    ...
    """
    # ------------------------------------------------------------------
    # TODONE: 4.  Follow the same instructions as in TODONE 3 above,
...
def test_clone():
   ...
   """
    # ------------------------------------------------------------------
    # TODONE: 5.  Follow the same instructions as in TODONE 3 above,
...
def test_move_to():
    ...
    """
    # ------------------------------------------------------------------
    # TODONE: 6.  Follow the same instructions as in TODONE 3 above,
...
def test_move_by():
    ...
    """
    # ------------------------------------------------------------------
    # TODONE: 7.  Follow the same instructions as in TODONE 3 above,
...
def test_get_number_of_moves_made():
    ...
    """
    # ------------------------------------------------------------------
    # TODONE: 8.  Follow the same instructions as in TODONE 3 above,
...
def test_get_distance_from():
    ...
    """
    # ------------------------------------------------------------------
    # TODONE: 9.  Follow the same instructions as in TODONE 3 above,
...
def test_get_distance_from_start():
    ...
    """
    # ------------------------------------------------------------------
    # TODONE: 10.  Follow the same instructions as in TODONE 3 above,
...
def test_get_distance_traveled():
    ...
    """
    # ------------------------------------------------------------------
    # TODONE: 11.  Follow the same instructions as in TODONE 3 above,
...
def test_closer_to():
    ...
    """
    # ------------------------------------------------------------------
    # TODONE: 12.  Follow the same instructions as in TODONE 3 above,
